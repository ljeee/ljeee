...
<table width="100%">
  <tr>
    <td width="60%">
      ...
      <p>
        🔹 <b>Problem Solver:</b> Whether it's crafting scalable backend architectures or hacking together native desktop apps, I enjoy solving complex puzzles. <br><br>
        🔹 <b>Versatile Builder:</b> From employability platforms and custom POS systems to real-time WebSockets and cross-platform monorepos. <br><br>
        🔹 <b>DevOps Enthusiast:</b> If it can be built, I'm probably figuring out how to dockerize it.
      </p>
    </td>
    <td width="40%" align="center">
      <img src="./gif/HuntressW.gif" alt="Huntress GIF" width="100%" style="border-radius: 10px; max-width: 300px;">
    </td>
  </tr>
</table>
...
![Cloudflare](https://img.shields.io/badge/Cloudflare_Zero_Trust-F38020?style=for-the-badge&logo=cloudflare&logoColor=white)
